...
from app.modules.rebalancing.router import router as rebalancing_router
...
from app.modules.swp.router import router as swp_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(rebalancing_router, prefix=API_PREFIX)
    app.include_router(swp_router, prefix=API_PREFIX)
