...
import { SWPPlans } from '../components/swp/SWPPlans';
...
export const GoalDetails: React.FC = () => {
  ...
  const isPayoutPhase = goal.status === 'payout' || goal.status === 'disbursing' || new Date(`${goal.target_date}T00:00:00`) <= new Date();
  ...
  return (
    <div className="goal-detail-page">
      ...
      {isPayoutPhase && <SWPPlans planType="goal" goalId={goal.id} expectedReturnPct={goal.expected_return_pct} />}
